          ...
          const registerDeviceToken = async () => {
              ...
              try {
                  ...
                  try {
                      ...
                      console.warn("FCM getToken note (memerlukan VAPID Key terkonfigurasi di Firebase Console):", err.message);
                  }
                  
                  if (currentToken && session && session.username) {
                  ...
                  console.warn("Gagal mendaftarkan token:", e);
              }
          };
